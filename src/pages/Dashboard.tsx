    ...
    <Layout>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 md:gap-6 mb-6 md:mb-8">
        <Card>
          ...
          <CardContent>
            <div className="text-xl md:text-2xl font-bold">142,384 kr</div>
        ...
        <Card>
          ...
          <CardContent>
            <div className="text-xl md:text-2xl font-bold">243</div>
            <p className="text-xs text-muted-foreground">
              <span className="text-green-500 flex items-center">
        ...
        <Card>
          ...
          <CardContent>
            <div className="text-xl md:text-2xl font-bold">586 kr</div>
            <p className="text-xs text-muted-foreground">
          ...
          <div className="overflow-x-auto -mx-6">
            <div className="inline-block min-w-full align-middle px-6">
              <table className="min-w-full">
                ...
                <tbody>
                  <tr className="border-b">
                    <td className="py-3 px-2 md:px-4 text-xs md:text-sm">#10024</td>
                    <td className="py-3 px-2 md:px-4 text-xs md:text-sm">Anders Jensen</td>
                    <td className="py-3 px-2 md:px-4 text-xs md:text-sm">3. apr 2025</td>
                    <td className="py-3 px-2 md:px-4 text-xs md:text-sm">1.245 kr</td>
                    <td className="py-3 px-2 md:px-4 text-xs md:text-sm"><span className="bg-green-100 text-green-800 px-2 py-1 rounded-full text-xs">Gennemført</span></td>
                  </tr>
                  <tr className="border-b">
                    <td className="py-3 px-2 md:px-4 text-xs md:text-sm">#10023</td>
                    <td className="py-3 px-2 md:px-4 text-xs md:text-sm">Maria Nielsen</td>
                    <td className="py-3 px-2 md:px-4 text-xs md:text-sm">2. apr 2025</td>
                    <td className="py-3 px-2 md:px-4 text-xs md:text-sm">860 kr</td>
                    <td className="py-3 px-2 md:px-4 text-xs md:text-sm"><span className="bg-blue-100 text-blue-800 px-2 py-1 rounded-full text-xs">Afsendt</span></td>
                  </tr>
                  <tr className="border-b">
                    <td className="py-3 px-2 md:px-4 text-xs md:text-sm">#10022</td>
                    <td className="py-3 px-2 md:px-4 text-xs md:text-sm">Lars Petersen</td>
                    <td className="py-3 px-2 md:px-4 text-xs md:text-sm">2. apr 2025</td>
                    <td className="py-3 px-2 md:px-4 text-xs md:text-sm">450 kr</td>
                    <td className="py-3 px-2 md:px-4 text-xs md:text-sm"><span className="bg-yellow-100 text-yellow-800 px-2 py-1 rounded-full text-xs">Behandles</span></td>
                  </tr>
                  <tr className="border-b">
                    <td className="py-3 px-2 md:px-4 text-xs md:text-sm">#10021</td>
                    <td className="py-3 px-2 md:px-4 text-xs md:text-sm">Sofie Hansen</td>
                    <td className="py-3 px-2 md:px-4 text-xs md:text-sm">1. apr 2025</td>
                    <td className="py-3 px-2 md:px-4 text-xs md:text-sm">1.780 kr</td>
                    <td className="py-3 px-2 md:px-4 text-xs md:text-sm"><span className="bg-green-100 text-green-800 px-2 py-1 rounded-full text-xs">Gennemført</span></td>
                  </tr>
                  <tr>
                    <td className="py-3 px-2 md:px-4 text-xs md:text-sm">#10020</td>
                    <td className="py-3 px-2 md:px-4 text-xs md:text-sm">Mikkel Andersen</td>
                    <td className="py-3 px-2 md:px-4 text-xs md:text-sm">1. apr 2025</td>
                    <td className="py-3 px-2 md:px-4 text-xs md:text-sm">925 kr</td>
                    <td className="py-3 px-2 md:px-4 text-xs md:text-sm"><span className="bg-green-100 text-green-800 px-2 py-1 rounded-full text-xs">Gennemført</span></td>
                  </tr>
                </tbody>
              </table>
